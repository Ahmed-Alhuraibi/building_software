...
config_paths = ['user_config.yml', 'job_config_argparse_var.yml']
...
# Group by column names added to configuration file   
Program_summary = (df_Col_Rename.groupby(config['group_by_column'])
