...
import argparse
df_Col_Rename = pd.read_csv('Alhuraibi_alamoudi_ahmed_python_assignment2_proc.csv')

Program_summary = (df_Col_Rename.groupby(['CITY','PROGRAM_AREA','PROGRAM_MODEL','SECTOR','CAPACITY_TYPE'])
...
ax.set_title('Bed Occupancy Analysis',fontsize=16)
